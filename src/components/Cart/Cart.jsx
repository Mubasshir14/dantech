    ...
    return (
        <div>
            ...
            <div className='max-w-screen-xl mx-auto min-h-[calc(100vh-250px)] md:-mt-32 -mt-36 p-4 md:p-8'>
                <div className="text-black font-bold text-xl md:text-2xl font-poppin uppercase text-center mb-8">Carts</div>
                                    ...
                                    <div className="card-body p-0 my-8 lg:my-0 lg:p-2 mt-4 lg:mt-0 flex flex-col justify-between ">
                                        ...
                                        <div>
                                            <div className="flex flex-col lg:flex-row lg:gap-3">
                                                <h2 className="text-[#FF4240] font-extrabold mb-3 lg:mb-0">Quantity- {c.quantity}
                                                </h2>
                                            </div>
                                            <div className="flex flex-col lg:flex-row lg:gap-3">
                                                <h2 className="text-[#FF4240] font-extrabold mb-3 lg:mb-0">Price - ${(c.price * c.quantity).toFixed(0)}
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
