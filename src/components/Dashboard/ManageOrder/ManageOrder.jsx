    ...
    return (
        <div>
            ...
            <div className='max-w-screen-xl mx-auto -mt-20 md:-mt-28'>
                <div>
                    <div className="text-black font-bold text-xl md:text-2xl font-poppin uppercase text-center mb-8">My Orders</div>
                                                    ...
                                                    {productIndex === 0 && (
                                                        <>
                                                            ...
                                                            <td className="py-2 px-4 text-center text-black uppercase">
                                                                <span className={`px-3 py-1 rounded text-white ${order.status === 'Shipped' ? 'bg-green-500' : order.status === 'Cancel' ? 'bg-red-500' : 'bg-[#097969]'}`}>
                                                                    {order.status}
                                                                </span>
                                                            </td>
